  ...
  return (
    <main className={`max-w-[1180px] p-5 m-auto`}>
      <section id="hero" className="h-screen flex items-center justify-center">
        <div className="flex flex-col w-full">
          ...
          <div className="flex gap-5 w-full justify-center items-center">
            <div className="border border-black border-2 p-2 rounded-full">
      ...
      <section id="services" className="mb-32">
        <h2 className="md:text-5xl text-3xl mb-10 text-lg">{services.title}</h2>
      ...
      <section id="projects" className="mb-32">
        <h2 className="md:text-5xl text-3xl mb-10 text-lg">{projects.title}</h2>
        <div className="grid md:grid-cols-3 grid-cols-1 gap-7">
          <div className="border-2 rounded-[8px] border-[#888] flex flex-col">
            <div className="min-h-64 flex items-center justify-center">
              <img src="/assets/sfera.png" className="max-w-44 m-auto " />
            </div>
          ...
          <div className="border-2 rounded-[8px] border-[#888] flex flex-col">
            <div className="min-h-64 flex items-center justify-center">
              <img src="/assets/ncs.png" className="max-w-44 m-auto" />
            </div>
            <p className="text-xl p-5 border-t-2 border-[#888] text-center">
          ...
          <div className="border-2 rounded-[8px] border-[#888] flex flex-col">
            <div className="min-h-64 flex items-center justify-center">
              <img src="/assets/iron.png" className="max-w-44 m-auto" />
            </div>
            <p className="text-xl p-5 border-t-2 border-[#888] text-center">
              Iron Gym
            </p>
